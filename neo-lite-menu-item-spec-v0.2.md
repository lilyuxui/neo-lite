# Neo-Lite Menu Item Component Specification v0.2

## 1. Purpose

`MenuItem` is the Neo-Lite interactive item primitive used inside Menu surfaces.

This version adds support for an optional leading decoration/icon while preserving the existing visual states and interaction model.
